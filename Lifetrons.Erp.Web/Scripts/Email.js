...
Email.init = function (e) {
    $(document).ready(Email.ready(e));
    $("#btnSearch").click(Email.Search);
    $("#sendButton").click(Email.SendEmail);
    $('input[type="submit"]').click(Email.Submit);
 };
