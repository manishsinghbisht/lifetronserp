var StockProductIssueLineItem = new Object();

StockProductIssueLineItem.init = function () {
    $(document).ready(StockProductIssueLineItem.ready);
    $('input[type="submit"]').click(StockProductIssueLineItem.Submit);
};

StockProductIssueLineItem.Submit = function () {
    var btn = jQuery(this);
...
StockProductIssueLineItem.ready = function () {
...
StockProductIssueLineItem.init();