...
Report.init = function () {
    $(document).ready(Report.ready);
    $("#btnSearch").click(Report.Search);
     $('input[type="submit"]').click(Report.Submit);
};
...
Report.Search = function () {
    //////$('#frmSearch').attr('action', 'Report/Search');
    //var pathname = window.location.pathname;
    //if (pathname.toLowerCase().indexOf("Report/") >= 0) {

    //    $('form[name="frmSearch"]').attr('action', 'Search');
    //}
    //else {
    //    $('form[name="frmSearch"]').attr('action', 'Report/Search');
    //}
