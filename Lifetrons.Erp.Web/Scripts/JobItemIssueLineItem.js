var JobItemIssueLineItem = new Object();

JobItemIssueLineItem.init = function () {
    $(document).ready(JobItemIssueLineItem.ready);
    $('input[type="submit"]').click(JobItemIssueLineItem.Submit);
};

JobItemIssueLineItem.Submit = function () {
    var btn = jQuery(this);
...
JobItemIssueLineItem.ready = function () {
