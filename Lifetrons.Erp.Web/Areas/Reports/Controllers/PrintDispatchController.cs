...
namespace Lifetrons.Erp.Reports.Controllers
{
    ...
    public class PrintDispatchController : BaseController
    {
        [Dependency]
        ...
        public ActionResult Print(string reportFormatType, string id)
        {
            ...
            string path = Path.Combine(Server.MapPath("~/Areas/Reports/Rdlc"), "Dispatch.rdlc");
            ...
            var headData = DispatchService.Select(id, applicationUser.Id, applicationUser.OrgId.ToString());
            ...
            var detailData = DispatchLineItemService.SelectLineItems(id, applicationUser.Id, applicationUser.OrgId.ToString());
        ...
        private DataTable CreateHeadDataTable(IEnumerable<Dispatch> headData)
        {
        ...
        private DataTable CreateDetailDataTable(IEnumerable<DispatchLineItem> detailData)
        {
            var applicationUser = new AccountController().GetUserById(User.Identity.GetUserId());
            //Grab objects for header creation 
