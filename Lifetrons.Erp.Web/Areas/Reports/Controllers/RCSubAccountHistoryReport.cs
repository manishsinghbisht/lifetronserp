...
namespace Lifetrons.Erp.Reports.Controllers
{
    ...
    public partial class SalesReportsController
    {
        ...
        #region SubAccountHistoryReport

        [HttpGet]
        [EsAuthorize(Roles = "OrganizationLevel")]
        public async Task<ActionResult> ParamSubAccountHistory()
        {
        ...
        [HttpPost]
        [EsAuthorize(Roles = "OrganizationLevel")]
        public async Task<ActionResult> ParamSubAccountHistory(string startDate, string endDate, string accountId)
        {
            ...
            TempData["AccountOrders"] = await OrderService.GetOrdersBySubAccountAsync(startDate1, endDate1, accountId, applicationUser.OrgId.ToString());
            ...
            return View("SubAccountHistoryReport");
        }
