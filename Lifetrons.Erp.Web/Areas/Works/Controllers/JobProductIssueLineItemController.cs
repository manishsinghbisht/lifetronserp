...
namespace Lifetrons.Erp.Works.Controllers
{
    ...
    public class JobProductIssueLineItemController : BaseController
    {
        private readonly IJobProductIssueService _service;
        ...
        // GET: /JobProductIssueLineItem/
        public JobProductIssueLineItemController(IJobProductIssueService service, IUnitOfWorkAsync unitOfWork, IJobIssueHeadService jobIssueHeadService,
        ...
        // GET: /JobProductIssueLineItem/Details/5
        ...
        // GET: /JobProductIssueLineItem/Create
        ...
        // POST: /JobProductIssueLineItem/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [EsAuthorize(Roles = "WorksPlanner, WorksAuthorize, WorksEdit")]
        public async Task<ActionResult> Create([Bind(Include = "JobIssueId,Serial,JobNo,Quantity,Weight,WeightUnitId,ExtraQuantity,DeliveryDate,Remark,CustomColumn1,Authorized")] JobProductIssue instance)
        {
        ...
        // GET: /JobProductIssueLineItem/Edit/5
        [EsAuthorize(Roles = "WorksPlanner, WorksAuthorize, WorksEdit")]
        public async Task<ActionResult> Edit(string id)
        {
            ...
            var applicationUser = new AccountController().GetUserById(User.Identity.GetUserId());
            JobProductIssue instance = await _service.FindAsync(id, applicationUser.Id, applicationUser.OrgId.ToString());
        ...
        private async Task SetupInstanceForm(ApplicationUser applicationUser, JobProductIssue instance)
        {
        ...
        // POST: /JobProductIssueLineItem/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Id,JobIssueId,Serial,JobNo,Quantity,Weight,WeightUnitId,ExtraQuantity,DeliveryDate,Remark,CustomColumn1,Authorized,Active,TimeStamp")] JobProductIssue instance)
        {
            if (User.Identity.IsAuthenticated)
            {
                var applicationUser = new AccountController().GetUserById(User.Identity.GetUserId());
                JobProductIssue model = await _service.FindAsync(instance.Id.ToString(), applicationUser.Id, applicationUser.OrgId.ToString());
                ...
                try
                {
                    if (TryValidateModel(model))
                    {
                        ...
                        var membersToCompare = new List<string>() { "Serial", "JobNo", "Quantity", "Weight", "WeightUnitId", "ExtraQuantity", "DeliveryDate", "Authorized", "Active" };
        ...
        // GET: /JobProductIssueLineItem/Delete/5
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            ...
            ViewBag.JobProductIssueId = model.JobIssueId;
            ViewBag.JobProductIssueHeadName = model.JobIssueHead.Name;
           
            return View(model);
        }

        // POST: /JobProductIssueLineItem/Delete/5
        ...
        public async Task<ActionResult> DeleteConfirmed(Guid id)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                {
                    JobProductIssue model = await _service.FindAsync(id.ToString(), applicationUser.Id, applicationUser.OrgId.ToString());
                    parentGuid = model.JobIssueId.ToString();
                    string logEntry = "Deleted JobProductIssue: Id=" + model.Id + " JobIssueId=" + model.JobIssueId + " JobNo=" + model.JobNo + "  DeliveryDate=" + model.DeliveryDate;
