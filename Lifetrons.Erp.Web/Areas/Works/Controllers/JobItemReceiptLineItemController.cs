...
namespace Lifetrons.Erp.Works.Controllers
{
    ...
    public class JobItemReceiptLineItemController : BaseController
    {
        private readonly IJobItemReceiptService _service;
        ...
        // GET: /JobItemReceiptLineItem/
        public JobItemReceiptLineItemController(IJobItemReceiptService service, IUnitOfWorkAsync unitOfWork, IJobReceiptHeadService jobReceiptHeadService,
        ...
        // GET: /JobItemReceiptLineItem/Details/5
        ...
        // GET: /JobItemReceiptLineItem/Create
        ...
        // POST: /JobItemReceiptLineItem/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [EsAuthorize(Roles = "WorksPlanner, WorksAuthorize, WorksEdit")]
        public async Task<ActionResult> Create([Bind(Include = "JobReceiptId,Serial,ItemId,JobNo,Quantity,Weight,WeightUnitId,Rate,Rejection,Remark,CustomColumn1,Authorized")] JobItemReceipt instance)
        {
        ...
        // GET: /JobItemReceiptLineItem/Edit/5
        [EsAuthorize(Roles = "WorksPlanner, WorksAuthorize, WorksEdit")]
        public async Task<ActionResult> Edit(string id)
        {
            ...
            var applicationUser = new AccountController().GetUserById(User.Identity.GetUserId());
            JobItemReceipt instance = await _service.FindAsync(id, applicationUser.Id, applicationUser.OrgId.ToString());
        ...
        private async Task SetupInstanceForm(ApplicationUser applicationUser, JobItemReceipt instance)
        {
        ...
        // POST: /JobItemReceiptLineItem/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Id,JobReceiptId,Serial,ItemId,JobNo,Quantity,Weight,WeightUnitId,Rate,Rejection,Remark,CustomColumn1,Authorized,Active,TimeStamp")] JobItemReceipt instance)
        {
            if (User.Identity.IsAuthenticated)
            {
                var applicationUser = new AccountController().GetUserById(User.Identity.GetUserId());
                JobItemReceipt model = await _service.FindAsync(instance.Id.ToString(), applicationUser.Id, applicationUser.OrgId.ToString());
                ...
                model.Rejection = instance.Rejection;
                ...
                try
                {
                    if (TryValidateModel(model))
                    {
                        ...
                        var membersToCompare = new List<string>() { "Serial", "ItemId", "JobNo", "Quantity", "Weight", "WeightUnitId", "Rate", "Rejection", "Authorized", "Active" };
        ...
        // GET: /JobItemReceiptLineItem/Delete/5
        [EsAuthorize(Roles = "WorksPlanner, WorksAuthorize, WorksEdit")]
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            ...
            ViewBag.JobItemReceiptId = model.JobReceiptId;
            ViewBag.JobItemReceiptHeadName = model.JobReceiptHead.Name;
           
            return View(model);
        }

        // POST: /JobItemReceiptLineItem/Delete/5
        ...
        public async Task<ActionResult> DeleteConfirmed(Guid id)
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                {
                    JobItemReceipt model = await _service.FindAsync(id.ToString(), applicationUser.Id, applicationUser.OrgId.ToString());
                    parentGuid = model.JobReceiptId.ToString();
                    string logEntry = "Deleted JobItemReceipt: Id=" + model.Id + " JobReceiptId=" + model.JobReceiptId + " JobNo=" + model.JobNo + "  ItemId=" + model.ItemId;
