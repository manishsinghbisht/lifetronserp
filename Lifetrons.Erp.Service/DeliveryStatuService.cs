...
{
    public class DeliveryStatuService : Service<DeliveryStatu>, IDeliveryStatuService
    {
        private readonly IRepositoryAsync<DeliveryStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public DeliveryStatuService(IRepositoryAsync<DeliveryStatu> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<DeliveryStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<DeliveryStatu> FindAsync(string id, string userId, string orgId)
        {
