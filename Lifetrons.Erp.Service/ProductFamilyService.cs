...
{
    public class ProductFamilyService : Service<ProductFamily>, IProductFamilyService
    {
        private readonly IRepositoryAsync<ProductFamily> _repository;
        private readonly IAspNetUserService _aspNetUserService;
        //private readonly IUnitOfWorkForService _unitOfWork;

        public ProductFamilyService(IRepositoryAsync<ProductFamily> repository, IAspNetUserService aspNetUserService)
            : base (repository)
        {
        ...
        public async Task<IEnumerable<ProductFamily>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<ProductFamily> FindAsync(string id, string userId, string orgId)
        {
        ...
        public ProductFamily Create(ProductFamily param, string userId, string orgId)
        {
        ...
        public void Update(ProductFamily param, string userId, string orgId)
        {
            if (param == null || string.IsNullOrEmpty(userId) || string.IsNullOrEmpty(orgId))
                throw new ApplicationException("Parameters cannot be null or empty");
        ...
        public IEnumerable<ProductFamily> GetPagedList(int pageNumber, int pageSize, out int totalRecords, string userId, string orgId)
        {
            Guid orgIdGuid = orgId.ToSysGuid();
            if (orgIdGuid == Guid.Empty)
            {
