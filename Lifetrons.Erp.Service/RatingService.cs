...
namespace Lifetrons.Erp.Service
{
    public class RatingService : Service<Rating>, IRatingService
    {
        ...
        public RatingService(IRepositoryAsync<Rating> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Rating>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Rating> FindAsync(string id, string userId, string orgId)
        {
