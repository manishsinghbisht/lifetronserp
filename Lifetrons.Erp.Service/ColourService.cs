...
namespace Lifetrons.Erp.Service
{
    public class ColourService : Service<Colour>, IColourService
    {
        ...
        public ColourService(IRepositoryAsync<Colour> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Colour>> SelectAsync(string userId, string orgId)
        {
        ...
        public async Task<Colour> FindAsync(string id, string userId, string orgId)
        {
