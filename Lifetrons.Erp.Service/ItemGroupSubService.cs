...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<ItemSubGroup> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public ItemSubGroupService(IRepositoryAsync<ItemSubGroup> repository, IAspNetUserService aspNetUserService)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<ItemSubGroup>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<ItemSubGroup> FindAsync(string id, string userId, string orgId)
        {
