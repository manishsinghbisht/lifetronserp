...
{
    public class OpportunityTypeService : Service<OpportunityType>, IOpportunityTypeService
    {
        private readonly IRepositoryAsync<OpportunityType> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public OpportunityTypeService(IRepositoryAsync<OpportunityType> repository, IAspNetUserService aspNetUserService)
            :base(repository)
        {
        ...
        public async Task<IEnumerable<OpportunityType>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<OpportunityType> FindAsync(string id, string userId, string orgId)
        {
