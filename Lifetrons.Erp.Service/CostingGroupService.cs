...
{
    public class CostingGroupService : Service<CostingGroup>, ICostingGroupService
    {
        private readonly IRepositoryAsync<CostingGroup> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public CostingGroupService(IRepositoryAsync<CostingGroup> repository, IAspNetUserService aspNetUserService) : base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<CostingGroup>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<CostingGroup> FindAsync(string id, string userId, string orgId)
        {
