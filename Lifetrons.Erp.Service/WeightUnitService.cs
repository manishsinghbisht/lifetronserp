...
{
    public class WeightUnitService : Service<WeightUnit>, IWeightUnitService
    {
        private readonly IRepositoryAsync<WeightUnit> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public WeightUnitService(IRepositoryAsync<WeightUnit> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<WeightUnit>> SelectAsync(string userId, string orgId)
        {
        ...
        public async Task<WeightUnit> FindAsync(string id, string userId, string orgId)
        {
