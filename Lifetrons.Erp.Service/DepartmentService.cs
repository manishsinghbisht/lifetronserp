...
namespace Lifetrons.Erp.Service
{
    public class DepartmentService : Service<Department>, IDepartmentService
    {
        ...
        public DepartmentService(IRepositoryAsync<Department> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Department>> SelectAsync(string userId, string orgId)
        {
        ...
        public async Task<Department> FindAsync(string id, string userId, string orgId)
        {
        ...
        public Department Find(string id, string userId, string orgId)
        {
            if (string.IsNullOrEmpty(id) || string.IsNullOrEmpty(userId) || string.IsNullOrEmpty(orgId)) return null;
        ...
        public Department Create(Department param, string userId, string orgId)
        {
            if (string.IsNullOrEmpty(userId) || string.IsNullOrEmpty(orgId)) return null;
        ...
        public void Update(Department param, string userId, string orgId)
        {
        ...
        public IEnumerable<Department> GetPagedList(int pageNumber, int pageSize, out int totalRecords, string userId, string orgId)
        {
            Guid orgIdGuid = orgId.ToSysGuid();
