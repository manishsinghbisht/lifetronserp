...
{
    public class TaskStatuService : Service<TaskStatu>, ITaskStatuService
    {
        private readonly IRepositoryAsync<TaskStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public TaskStatuService(IRepositoryAsync<TaskStatu> repository, IAspNetUserService aspNetUserService) : base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<TaskStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<TaskStatu> FindAsync(string id, string userId, string orgId)
        {
