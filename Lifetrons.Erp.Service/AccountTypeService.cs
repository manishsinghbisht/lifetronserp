...
namespace Lifetrons.Erp.Service
{
    public class AccountTypeService : Service<AccountType>, IAccountTypeService
    {
        ...
        public AccountTypeService(IRepositoryAsync<AccountType> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<AccountType>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<AccountType> FindAsync(string id, string userId, string orgId)
        {
