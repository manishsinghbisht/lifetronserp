...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<Priority> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public PriorityService(IRepositoryAsync<Priority> repository, IAspNetUserService aspNetUserService)
            :base (repository)
        {
        ...
        public async Task<IEnumerable<Priority>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Priority> FindAsync(string id, string userId, string orgId)
        {
