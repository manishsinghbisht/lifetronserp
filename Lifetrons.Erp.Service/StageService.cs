...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<Stage> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public StageService(IRepositoryAsync<Stage> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Stage>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Stage> FindAsync(string id, string userId, string orgId)
        {
