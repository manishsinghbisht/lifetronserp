...
{
    public class CaseStatusService : Service<CaseStatu>, ICaseStatusService
    {
        private readonly IRepositoryAsync<CaseStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public CaseStatusService(IRepositoryAsync<CaseStatu> repository, IAspNetUserService aspNetUserService):base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<CaseStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<CaseStatu> FindAsync(string id, string userId, string orgId)
        {
