...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<Level> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public LevelService(IRepositoryAsync<Level> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Level>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Level> FindAsync(string id, string userId, string orgId)
        {
