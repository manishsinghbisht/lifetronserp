...
{
    public class QuoteStatusService : Service<QuoteStatu>, IQuoteStatusService
    {
        private readonly IRepositoryAsync<QuoteStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public QuoteStatusService(IRepositoryAsync<QuoteStatu> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<QuoteStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<QuoteStatu> FindAsync(string id, string userId, string orgId)
        {
