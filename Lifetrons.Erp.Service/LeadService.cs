...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<Lead> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public LeadService(IRepositoryAsync<Lead> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Lead>> SelectAsync(string userId, string orgId)
        {
        ...
        public async Task<Lead> FindAsync(string id, string userId, string orgId)
        {
        ...
        public Lead Create(Lead param, string userId, string orgId)
        {
        ...
        public void Update(Lead param, string userId, string orgId)
        {
            if (param == null || string.IsNullOrEmpty(userId) || string.IsNullOrEmpty(orgId))
                throw new ApplicationException("Parameters cannot be null or empty");
        ...
        public IEnumerable<Lead> GetPagedList(int pageNumber, int pageSize, out int totalRecords, string userId, string orgId)
        {
            Guid orgIdGuid = orgId.ToSysGuid();
            if (orgIdGuid == Guid.Empty)
            {
