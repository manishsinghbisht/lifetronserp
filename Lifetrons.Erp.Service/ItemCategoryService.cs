...
{
    public class ItemCategoryService : Service<ItemCategory>, IItemCategoryService
    {
        private readonly IRepositoryAsync<ItemCategory> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public ItemCategoryService(IRepositoryAsync<ItemCategory> repository, IAspNetUserService aspNetUserService):base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<ItemCategory>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<ItemCategory> FindAsync(string id, string userId, string orgId)
        {
