...
{
    public class ItemClassificationService : Service<ItemClassification>, IItemClassificationService
    {
        private readonly IRepositoryAsync<ItemClassification> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public ItemClassificationService(IRepositoryAsync<ItemClassification> repository, IAspNetUserService aspNetUserService):base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<ItemClassification>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<ItemClassification> FindAsync(string id, string userId, string orgId)
        {
