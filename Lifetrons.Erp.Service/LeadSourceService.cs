...
{
    public class LeadSourceService : Service<LeadSource>, ILeadSourceService
    {
        private readonly IRepositoryAsync<LeadSource> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public LeadSourceService(IRepositoryAsync<LeadSource> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<LeadSource>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<LeadSource> FindAsync(string id, string userId, string orgId)
        {
