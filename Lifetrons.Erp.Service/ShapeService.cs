...
namespace Lifetrons.Erp.Service
{
    ...
    {
        private readonly IRepositoryAsync<Shape> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public ShapeService(IRepositoryAsync<Shape> repository, IAspNetUserService aspNetUserService) : base(repository)
         {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<Shape>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Shape> FindAsync(string id, string userId, string orgId)
        {
