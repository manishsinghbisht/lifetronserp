...
namespace Lifetrons.Erp.Service
{
    public class IndustryService : Service<Industry>, IIndustryService
    {
        ...
        public IndustryService(IRepositoryAsync<Industry> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Industry>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Industry> FindAsync(string id, string userId, string orgId)
        {
