...
{
    public class NatureService : Service<Nature>, INatureService
    {
        private readonly IRepositoryAsync<Nature> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public NatureService(IRepositoryAsync<Nature> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Nature>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Nature> FindAsync(string id, string userId, string orgId)
        {
