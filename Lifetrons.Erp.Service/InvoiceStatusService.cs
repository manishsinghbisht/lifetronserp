...
{
    public class InvoiceStatusService : Service<InvoiceStatu>, IInvoiceStatusService
    {
        private readonly IRepositoryAsync<InvoiceStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public InvoiceStatusService(IRepositoryAsync<InvoiceStatu> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<InvoiceStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<InvoiceStatu> FindAsync(string id, string userId, string orgId)
        {
