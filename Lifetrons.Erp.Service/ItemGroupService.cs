...
{
    public class ItemGroupService : Service<ItemGroup>, IItemGroupService
    {
        private readonly IRepositoryAsync<ItemGroup> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public ItemGroupService(IRepositoryAsync<ItemGroup> repository, IAspNetUserService aspNetUserService):base(repository)
        {
            _repository = repository;
            _aspNetUserService = aspNetUserService;
        }

        public async Task<IEnumerable<ItemGroup>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<ItemGroup> FindAsync(string id, string userId, string orgId)
        {
