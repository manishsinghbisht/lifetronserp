...
{
    public class LeadStatuService : Service<LeadStatu>, ILeadStatuService
    {
        private readonly IRepositoryAsync<LeadStatu> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public LeadStatuService(IRepositoryAsync<LeadStatu> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<LeadStatu>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<LeadStatu> FindAsync(string id, string userId, string orgId)
        {
