...
{
    public class OwnershipService : Service<Ownership>, IOwnershipService
    {
        private readonly IRepositoryAsync<Ownership> _repository;
        private readonly IAspNetUserService _aspNetUserService;

        public OwnershipService(IRepositoryAsync<Ownership> repository, IAspNetUserService aspNetUserService)
            : base(repository)
        {
        ...
        public async Task<IEnumerable<Ownership>> GetAsync(string userId, string orgId)
        {
        ...
        public async Task<Ownership> FindAsync(string id, string userId, string orgId)
        {
